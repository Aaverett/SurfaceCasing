...
/// <summary>
/// Summary description for _100FtForTD_Year4
/// </summary>
public class _100FtForTD_Year4 : BaseLogicSet, ILogicSet
{
    public override object GetFactoryKey()
    {
        return "100 feet for TD Year 4";
    }
    ...
    public override HtmlGenericControl  GenerateOutputControl()
    {
        ...
        usdwValueCell.Text = constants.PROTECT_MESSAGE;
        ...
        //usdwstring = "The USDW (10,000 ppm TDS) is estimated to occur at a depth of " + Decimal.Round(new Decimal(usdwgsfc), 0).ToString() + "' Depth (" + Decimal.Round(new Decimal(Math.Abs(usdwmsl)), 0).ToString() + "' " + sUSDWMSLAbove + " MSL)";
        ...
        disclaimerparagraph.InnerHtml = "Note:  This is an approximate recommendation and is subject to confirmation by a <a href=\"http://www.tnrcc.state.tx.us/permitting/wasteperm/uicrw/uic/surface.html\" target=\"_blank\" title=\"TCEQ Website\">TCEQ</a> Surface Casing geologist.";
