...
/// <summary>
/// This logic class is used for the more complex portion of the Carrizo-Wilcox aquifer at the far east side of the 2011 study area.
/// </summary>
public class CarrizoWilcoxComplex : BaseLogicSet, ILogicSet
{
    public override object GetFactoryKey()
    {
        return "CarrizoWilcoxComplex";
    }
    ...
    public virtual HtmlGenericControl GenerateOutputControl()
    {
        ...
        fwizBotValueCell.Text = "See protected base of usable quality water";
